import type { WorldDefinition } from "../schema";
 ...
 */
export const neonWarszawa: WorldDefinition = {
  ...
  classPortraitsBaseUrl:
    "/images/cyberpunk/neon-warszawa/characters/classes/",
